...
public class ClientIdPartitionerTest {
    @Rule
    ...
    private Client CLIENT2 = new Client(0, CreditRating.AA);
    private Client CLIENT3 = new Client(2, CreditRating.BB);
    ...
    @Test
    public void testUniqueIdsForDifferentClientIDs() {
    ...
    @Test
    public void testIdenticalKeysForIdenticalClientIDs() {
        doReturn(CLIENT1).when(trade).getClient();
        SecurityGroupId first = partitioner.findGroupForPosition(position);
