...
public class OptionPosition implements Position {
    ...
    public OptionPosition(int clientId, MarketValuation marketValuation) {
    ...
    public boolean equals(Object o) {
        ...
        OptionPosition position = (OptionPosition) o;
