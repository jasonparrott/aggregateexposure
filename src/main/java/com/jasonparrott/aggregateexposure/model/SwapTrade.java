...
public class SwapTrade extends LinearProduct {
    ...
    public SwapTrade(TradeAction action, LocalDate today, LocalDate previous, MetricsCalculator metricsCalculator, int clientId) throws RiskCalculationException {
