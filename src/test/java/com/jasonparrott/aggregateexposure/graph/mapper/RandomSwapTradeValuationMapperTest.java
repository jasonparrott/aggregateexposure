...
public class RandomSwapTradeValuationMapperTest {
    @Rule
    ...
    @Test
    public void testMapperAllowsSwapTrade() {
        doReturn(ProductType.Swap).when(securityGroup).getProductType();
        RandomSwapTradeValuationMapper mapper = new RandomSwapTradeValuationMapper();
        assertThat(mapper.canMap(securityGroup), is(true));
    }

    @Test
    public void testMapperRejectsNonSwapTrades() {
    ...
    @Test
    public void testMappingSwapTradeReturnsValidNodes() {
        RandomSwapTradeValuationMapper mapper = new RandomSwapTradeValuationMapper();
